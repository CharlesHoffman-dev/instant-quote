...
export default function InstantQuoteSchedule() {
  ...
  return (
    <div
      className="max-w-[1280px] mx-auto px-0 pt-0 bg-[#f2f3f8] text-base"
      style={{
        fontFamily:
    ...
    >
      ...
      <style jsx>{`
        ...
        @keyframes borderPulse {
          0% {
            box-shadow: 0 0 0 0 rgba(39, 85, 248, 0.45);
          }
          60% {
            box-shadow: 0 0 0 8px rgba(39, 85, 248, 0);
          }
          100% {
            box-shadow: 0 0 0 0 rgba(39, 85, 248, 0);
          }
        }
        .pulse-border {
